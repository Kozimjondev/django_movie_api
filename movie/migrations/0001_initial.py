    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='show money in dollars', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='show money in dollars', verbose_name='Fees in USA')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='show money in dollars', verbose_name='Fees in the world')),
                ('url', models.SlugField(max_length=100, unique=True)),
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movie.category', verbose_name='Categories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='Trailers')),
                ('description', models.TextField(verbose_name='Description')),
